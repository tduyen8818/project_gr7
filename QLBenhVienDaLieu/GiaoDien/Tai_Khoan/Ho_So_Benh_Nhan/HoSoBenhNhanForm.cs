...
namespace QLBenhVienDaLieu.GiaoDien.Ho_So_Benh_Nhan
{
    public partial class HoSoBenhNhanForm : Form
    {
        ...
        private void dataHoVaTen_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                dataHoVaTen.ForeColor = Color.Black;
                
            } else
            {
                dataHoVaTen.ForeColor = Color.Red;
            }
        ...
        private void dataNgaySinh_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    dataNgaySinh.ForeColor = Color.Black;
                }
                else
                {
                    dataNgaySinh.ForeColor = Color.Red;
        ...
        private void dataGioiTinh_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                dataGioiTinh.ForeColor = Color.Black;
            } else
            {
                dataGioiTinh.ForeColor= Color.Red;
        ...
        private void dataCCCD_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                dataCCCD.ForeColor = Color.Black;

            } else
            {
                dataCCCD.ForeColor= Color.Red;
        ...
        private void dataMaBHYT_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                dataMaBHYT.ForeColor = Color.Black;

            } else
            {
                dataMaBHYT.ForeColor= Color.Red;
        ...
        private void dataNgheNghiep_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                dataNgheNghiep.ForeColor = Color.Black;
            } else
            {
                dataNgheNghiep.ForeColor= Color.Red;
        ...
        private void dataSoDienThoai_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                dataSoDienThoai.ForeColor = Color.Black;
            } else
            {
                dataSoDienThoai.ForeColor= Color.Red;
        ...
        private void dataEmail_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                dataEmail.ForeColor = Color.Black;
            } else
            {
                dataEmail.ForeColor= Color.Red;
        ...
        private void HoSoBenhNhanForm_MouseWheel(object sender, MouseEventArgs e)
        {
            if(e.Delta > 0)
            {
                buttonArrowRight_Click(sender, e);
            } else
            {
                buttonArrowLeft_Click(sender, e);
            }
