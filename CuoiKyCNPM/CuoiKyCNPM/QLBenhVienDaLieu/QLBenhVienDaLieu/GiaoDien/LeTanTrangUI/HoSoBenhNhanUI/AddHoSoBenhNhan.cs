...
{
    public partial class AddHoSoBenhNhan : Form
    {
        ...
        private float textSizeInitialTitleThemHoSoBenhNhan;
        ...
        public AddHoSoBenhNhan(string maTaiKhoan, LeTan_Trang leTan_Trang, SqlFunctionCaller sqlFunctionCaller)
        {
            ...
            originalTitleThemHoSoBenhNhan = new Rectangle(titleThemHoSoBenhNhan.Location.X, titleThemHoSoBenhNhan.Location.Y, titleThemHoSoBenhNhan.Width, titleThemHoSoBenhNhan.Height);
            ...
            textSizeInitialTitleThemHoSoBenhNhan = titleThemHoSoBenhNhan.Font.Size;
        ...
        private void AddHoSoBenhNhan_Resize(object sender, EventArgs e)
        {
            if (originalForm.Width != 0 && textDiaChi.Font.Size != 0)
            {
                Graphic.ScaleSize.Resize(originalForm, originalTitleThemHoSoBenhNhan, titleThemHoSoBenhNhan, this, textSizeInitialTitleThemHoSoBenhNhan);
        ...
        private void buttonLuuHoSo_Click(object sender, EventArgs e)
        {
            ...
            {
                sqlFunctionCaller.InsertHoSoBenhNhan(dataHoVaTen.Text, this.maTaiKhoan,
        ...
        private void buttonReturn_Click(object sender, EventArgs e)
        {
            ...
            hoSoBenhNhanForm.TextBoxSearchSoDienThoai.Text = this.maTaiKhoan;
